...
async def message_handler(msg):
    try:
        ...
        print("Exception lors du traitement du message :", str(e))

async def main():
    nc = await nats.connect("nats://natslogging:4222")
    print("Connexion NATS établie. En écoute...")

    topics = ["log.agents.info", "log.agents.error", "log.agents.warning","log.membres.info", "log.membres.error", "log.membres.warning"]
